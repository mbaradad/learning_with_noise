...
# replicates sun.py from
class Sun397_ours(tfds.core.GeneratorBasedBuilder):
  ...
  def __init__(self, tfds_split_files=None, **kwargs):
    super(Sun397_ours, self).__init__(**kwargs)
    ...
    with tf.Graph().as_default():
      with utils.nogpu_session() as sess:
        for filepath, fobj in archive:
          ...
          # skip non-working file
          if filename in ['/t/track/outdoor/sun_aophkoiosslinihb.jpg']:
            continue
